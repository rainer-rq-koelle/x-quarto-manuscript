...
\hypersetup{
  pdftitle={RQ's La Palma Earthquakes},
  pdfauthor={Rainer RQ Koelle; Rowan Cockett},
...
\begin{document}
\title{RQ's La Palma Earthquakes}

\authors{Rainer RQ Koelle\affil{1}, Rowan Cockett\affil{1}}
\affiliation{1}{Curvenote, }
\correspondingauthor{Rainer RQ Koelle}{steve@curvenote.com}
...
Nacional (IGN). This is now edits Rainer has done to play around wiht
the template and get a feeling for waht is what.
\end{abstract}
...
This paper does something. It is my first stab at working with the
Quarto-manuscript format.

\section{Introduction}\label{introduction}

\textsubscript{Source:
\href{https://rainer-rq-koelle.github.io/x-quarto-manuscript/index.qmd.html}{Article
Notebook}}
...
\textsubscript{Source:
\href{https://rainer-rq-koelle.github.io/x-quarto-manuscript/notebooks/explore-earthquakes-preview.html\#cell-fig-spatial-plot}{Explore
Earthquakes}}
